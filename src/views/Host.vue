...
<div class="container d-flex flex-row mt-4 pl-0 page-container">      
    ...
    <div class="d-flex flex-column m-auto left-container">
      ...
      >
        <div
          class="signUpForm w3-content col-md-12 col-sm-12 d-flex flex-column justify-content-center align-items-center mb-3" v-if="!host"
        >
        ...
        <p><br></p>
        <p v-if="host">Meeting Url: <a :href="hostUrl">{{hostUrl}}</a> </p>
      </div>
